        ...
        <div className="form-card col-span-3">
          ...
          </div>
          {
            task?.attachment?.length > 0 && (
              <div className="mt-2">
                <label htmlFor="" className='text-xs font-medium text-slate-500 '>Attachment</label>
...
const Attachment = ({link,index,onClick})=>{
  return <>
  <div className="flex justify-between bg-gray-50 border border-gray-100 px-2 py-2 rounded-md mb-3 mt-2 cursor-pointer" onClick={onclick}>
...
<LuSquareArrowOutUpRight className='text-gay-400'/>
  </div>
  </>
}