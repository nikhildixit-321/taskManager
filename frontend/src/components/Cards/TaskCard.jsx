...
const TaskCard = ({
  ...
  attachmentCount,
  completedTodoCount,
  todoChecklist = [], // ✅ Added default empty array
  onClick, // ✅ Accept onClick from props
}) => {
  ...
  return (
    <div
      className="bg-white rounded-xl py-4 shadow-gray-100 border border-gray-200 cursor-pointer"
